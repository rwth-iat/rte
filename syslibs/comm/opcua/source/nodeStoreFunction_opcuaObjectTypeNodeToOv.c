...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_opcuaObjectTypeNodeToOv(
		void *handle, UA_ObjectTypeNode* opcuaNode, OV_INSTPTR_opcua_objectTypeNode* ovNode, UA_NodeId *parrentNode) {
	OV_RESULT result = 0;
...
//	}else
	...
	*ovNode = NULL;
	result = Ov_CreateObject(opcua_objectTypeNode, *ovNode, ptr, tmpString);
	if (*ovNode == NULL)
		return result;
