...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_ovVariableTypeNodeToOPCUA(
		void *handle, OV_INSTPTR_opcua_variableTypeNode ovNode, UA_VariableTypeNode** opcuaNode) {
	OV_INSTPTR_ov_object pchild = NULL;
	*opcuaNode = NULL;
	*opcuaNode = ov_database_malloc(sizeof(UA_VariableTypeNode));
	if (*opcuaNode == NULL)
		return 99;
