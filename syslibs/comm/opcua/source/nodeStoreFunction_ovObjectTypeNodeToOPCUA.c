...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_ovObjectTypeNodeToOPCUA(
		void *handle, OV_INSTPTR_opcua_objectTypeNode ovNode, UA_ObjectTypeNode** opcuaNode) {
	OV_INSTPTR_ov_object pchild = NULL;
	*opcuaNode = NULL;
	*opcuaNode = ov_database_malloc(sizeof(UA_ObjectTypeNode));
	if (*opcuaNode == NULL)
		return 99;
