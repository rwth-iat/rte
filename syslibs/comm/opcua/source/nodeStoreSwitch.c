...
//	UA_free(pSwitch->nodestoreArray[i]->context);
//	UA_free(pSwitch->nodestoreArray[i]->deleteNode);
//	UA_free(pSwitch->nodestoreArray[i]->deleteNodestore);
//	UA_free(pSwitch->nodestoreArray[i]->inPlaceEditAllowed);
//	UA_free(pSwitch->nodestoreArray[i]->newNode);
//	UA_free(pSwitch->nodestoreArray[i]->getNode);
//	UA_free(pSwitch->nodestoreArray[i]->getNodeCopy);
//	UA_free(pSwitch->nodestoreArray[i]->releaseNode);
//	UA_free(pSwitch->nodestoreArray[i]->insertNode);
//	UA_free(pSwitch->nodestoreArray[i]->replaceNode);
//	UA_free(pSwitch->nodestoreArray[i]->removeNode);
//	UA_free(pSwitch->nodestoreArray[i]->iterate);
