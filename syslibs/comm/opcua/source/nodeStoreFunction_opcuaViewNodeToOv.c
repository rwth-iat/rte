...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_opcuaViewNodeToOv(
		void *handle, UA_ViewNode* opcuaNode, OV_INSTPTR_opcua_viewNode* ovNode, UA_NodeId *parrentNode) {
...
//	}else
	...
	*ovNode = NULL;
	result = Ov_CreateObject(opcua_viewNode, *ovNode, ptr, tmpString);
	if (*ovNode == NULL)
		return result;
	...
	(*ovNode)->v_containNoLoops = opcuaNode->containsNoLoops;
	return result;
}
