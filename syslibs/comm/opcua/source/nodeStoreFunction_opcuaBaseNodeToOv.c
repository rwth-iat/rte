...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_opcuaBaseNodeToOv(
		void *handle, UA_Node *opcuaNode, OV_INSTPTR_opcua_baseNode* ovNode, UA_NodeId *parrentNode) {
		OV_RESULT result = 0;
...
//		}else
		...
		*ovNode = NULL;
		result = Ov_CreateObject(opcua_baseNode, *ovNode, ptr, tmpString);
		if (*ovNode == NULL)
			return result;
