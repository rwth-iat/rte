...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_opcuaMethodNodeToOv(
		void *handle, UA_MethodNode* opcuaNode, OV_INSTPTR_opcua_methodNode* ovNode, UA_NodeId *parrentNode) {
...
//	}else
	...
	*ovNode = NULL;
	result = Ov_CreateObject(opcua_methodNode, *ovNode, ptr, tmpString);
	if (*ovNode == NULL)
		return result;
	...
	(*ovNode)->v_executable = opcuaNode->executable;
	//(*ovNode)->v_userExecutable = opcuaNode->userExecutable;
