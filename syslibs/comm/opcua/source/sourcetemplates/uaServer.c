...
OV_DLLFNCEXPORT UA_StatusCode opcua_uaServer_addInformationModel(OV_STRING *namespaces, OV_UINT namespaceIndex, OV_UINT namespaceSize, OV_STRING *StartFolder, opcua_loadInformationModel *loadInfoModel) {
