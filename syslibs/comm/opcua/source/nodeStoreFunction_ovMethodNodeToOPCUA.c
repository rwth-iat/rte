...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_ovMethodNodeToOPCUA(
		void *handle, OV_INSTPTR_opcua_methodNode ovNode, UA_MethodNode** opcuaNode) {
	OV_INSTPTR_ov_object pchild = NULL;
	*opcuaNode = NULL;
	*opcuaNode = ov_database_malloc(sizeof(UA_MethodNode));
	if (*opcuaNode == NULL)
		return 99;
	...
	//view related fields
	(*opcuaNode)->executable = ovNode->v_executable;
	//(*opcuaNode)->userExecutable = ovNode->v_userExecutable;
