...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_opcuaDataTypeNodeToOv(
		void *handle, UA_DataTypeNode* opcuaNode, OV_INSTPTR_opcua_dataTypeNode* ovNode, UA_NodeId *parrentNode) {
...
//	}else
	...
	*ovNode = NULL;
	result = Ov_CreateObject(opcua_dataTypeNode, *ovNode, ptr, tmpString);
	if (*ovNode == NULL)
