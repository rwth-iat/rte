...
OV_DLLFNCEXPORT UA_StatusCode opcua_nodeStoreFunctions_ovDataTypeNodeToOPCUA(
		void *handle, OV_INSTPTR_opcua_dataTypeNode ovNode, UA_DataTypeNode** opcuaNode) {
	OV_INSTPTR_ov_object pchild = NULL;
	*opcuaNode = NULL;
	*opcuaNode = ov_database_malloc(sizeof(UA_DataTypeNode));
	if (*opcuaNode == NULL)
		return 99;
