...
{
	return UA_NodestoreSwitch_deleteNode(nodestoreContext, node);
}
...
{
	return UA_NodestoreSwitch_releaseNode(nodestoreContext, node);
}
...
{
	return UA_NodestoreSwitch_iterate(nodestoreContext, visitorContext, visitor);
}
