...
UA_StatusCode UA_NodestoreSwitch_linkNodestore(UA_NodestoreSwitch *ptrSwitch ,void *nodestoreHandle);
UA_StatusCode UA_NodestoreSwitch_unlinkNodestore(UA_NodestoreSwitch *ptrSwitch ,void *nodestoreHandle);
UA_StatusCode UA_NodestoreSwitch_changeNodestore(UA_NodestoreSwitch *ptrSwitch ,void *nodestoreHandle);


void UA_NodestoreSwitch_deleteNode(UA_NodeId *NodeId);
/**
