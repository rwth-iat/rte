...
OV_DLLFNCEXPORT OV_RESULT dynov_islinkfnc_link(
        const OV_PPT_dynov_islinkfnc                 pparent,
        const OV_CPT_dynov_islinkfnc                 pchild,
        const OV_PLACEMENT_HINT            parenthint,
        const OV_CPT_dynov_islinkfnc                 prelparent,
        const OV_PLACEMENT_HINT            childhint,
        const OV_CPT_dynov_islinkfnc                 prelchild
) {
        return ov_association_link(passoc_dynov_islinkfnc, Ov_PtrUpCast
...
OV_DLLFNCEXPORT void dynov_islinkfnc_unlink(
        const OV_PPT_dynov_islinkfnc                 pparent,
        const OV_CPT_dynov_islinkfnc                 pchild
) {
        ov_association_unlink(passoc_dynov_islinkfnc, Ov_PtrUpCast
                      (ov_object, pparent), Ov_PtrUpCast(ov_object, pchild));
}

OV_DLLFNCEXPORT OV_ACCESS dynov_islinkfnc_getaccess(
        const OV_PPT_dynov_islinkfnc                 pparent,
        const OV_CPT_dynov_islinkfnc                 pchild,
