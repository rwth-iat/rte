...
proc processDir {dirname} {
	...
	foreach filename $filelist {
		...
		puts $out "	pindexhtml = Ov_SearchChildEx(ov_containment, pdom, \"$filename\", kshttp_staticfile);"
		puts $out "	if(!pindexhtml)"
		puts $out "	\{"
		puts $out "		result = Ov_CreateObject(kshttp_staticfile, pindexhtml, pdom, \"$filename\");"
...
puts $out "#ifndef OV_COMPILE_LIBRARY_kshttp"
puts $out "#define OV_COMPILE_LIBRARY_kshttp"
puts $out "#endif"
puts $out ""
...
puts $out "	OV_INSTPTR_kshttp_staticfile	pindexhtml = NULL;"
