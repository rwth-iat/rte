...
ADD_LIBS_SWITCHES = fb$(_DLL) ssc$(_DLL) ksbase$(_DLL)
...
templates: 
	...
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(FB_MODEL_DIR) -I $(SSC_MODEL_DIR) -I $(KSBASE_MODEL_DIR) -f $(MODEL_DIR)$(LIBRARY).ovm -l $(LIBRARY)
...
$(LIBRARY).c $(LIBRARY).h: $(wildcard $(MODEL_DIR)$(LIBRARY).ov?) Makefile
	sed -i -e 's///' $(MODEL_DIR)$(LIBRARY).ovm
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(FB_MODEL_DIR) -I $(SSC_MODEL_DIR) -I $(KSBASE_MODEL_DIR) -I $(MODEL_DIR) -f $(MODEL_DIR)$(LIBRARY).ovm -l $(notdir $(basename $<))

%.c %.h: %.ovm Makefile
	sed -i -e 's///' $<
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(FB_MODEL_DIR) -I $(SSC_MODEL_DIR) -I $(KSBASE_MODEL_DIR) -I $(MODEL_DIR) -f $< -l $(notdir $(basename $<))
...
$(USERLIB_DLL) : $(USERLIB_OBJ) $(ADD_LIBS)
	...
	cp $(USERLIB_DIR)/ssc$(_DLL) ssc$(_DLL)
