...
BASELIB1_DIR           = ../../../fb/
BASELIB1_MODEL_DIR     = $(BASELIB1_DIR)model/
BASELIB1_INCLUDE_DIR   = $(BASELIB1_DIR)include/
BASELIB1_SOURCE_DIR    = $(BASELIB1_DIR)source/
BASELIB1_BUILD_DIR     = $(BASELIB1_DIR)build/$(SYSDIR)/
...
MYLIB_INCLUDES = \
	...
	-I$(BASELIB1_MODEL_DIR) \
	-I$(BASELIB1_INCLUDE_DIR) \
	-I$(MYLIB_MODEL_DIR) \
	-I$(MYLIB_INCLUDE_DIR)
