...
RASPI_MODEL_DIR           = $(USER_DIR)raspi/model/
RASPI_INCLUDE_DIR         = $(USER_DIR)raspi/include/
IEC61131STDFB_MODEL_DIR           = $(USER_DIR)iec61131stdfb/model/
IEC61131STDFB_INCLUDE_DIR         = $(USER_DIR)iec61131stdfb/include/
...
INCLUDES  = /I$(BASE_INC_DIR) /I$(BASE_MODEL_DIR) \
			...
			/I$(RASPI_MODEL_DIR) /I$(RASPI_INCLUDE_DIR) \
			/I$(IEC61131STDFB_MODEL_DIR) /I$(IEC61131STDFB_INCLUDE_DIR) \
...
VPATH     = $(MODEL_DIR) $(SOURCE_DIR) $(INCLUDE_DIR) \
			...
			$(RASPI_MODEL_DIR) $(RASPI_INCLUDE_DIR) \
			$(IEC61131STDFB_MODEL_DIR) $(IEC61131STDFB_INCLUDE_DIR) \
			$(FB_MODEL_DIR) $(FB_INCLUDE_DIR) \
			$(BASE_INC_DIR) $(BASE_MODEL_DIR)

ifeq ($(COMPILER), MSVC)
DEFINES    = /DOV_SYSTEM_$(SYSTEM)=1 /DPLT_SYSTEM_$(SYSTEM)=1 /Dov_library_open_openaasExample=ov_library_open_openaasExample_old
else
DEFINES    = -DOV_SYSTEM_$(SYSTEM)=1 -DPLT_SYSTEM_$(SYSTEM)=1 -Dov_library_open_openaasExample=ov_library_open_openaasExample_old
endif
