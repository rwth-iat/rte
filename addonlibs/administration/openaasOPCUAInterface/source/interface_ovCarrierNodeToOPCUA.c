...
OV_DLLFNCEXPORT UA_StatusCode openaasOPCUAInterface_interface_ovCarrierNodeToOPCUA(
	...
	*nodeClass = UA_NODECLASS_VARIABLE;
	...
	((UA_VariableNode*)newNode)->dataType.namespaceIndex = pinterface->v_modelnamespace.index;
