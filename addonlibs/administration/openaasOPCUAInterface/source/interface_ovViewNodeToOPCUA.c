...
OV_DLLFNCEXPORT UA_StatusCode openaasOPCUAInterface_interface_ovViewNodeToOPCUA(
	...
	// dataType
	((UA_VariableNode*)newNode)->dataType = UA_NODEID_NUMERIC(pinterface->v_modelnamespaceIndexPropertyValueStatement, UA_NS2ID_VIEWENUM);
