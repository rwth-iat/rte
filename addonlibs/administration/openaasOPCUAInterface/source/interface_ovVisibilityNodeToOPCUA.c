...
OV_DLLFNCEXPORT UA_StatusCode openaasOPCUAInterface_interface_ovVisibilityNodeToOPCUA(
	...
	// dataType
	((UA_VariableNode*)newNode)->dataType = UA_NODEID_NUMERIC(pinterface->v_modelnamespaceIndexPropertyValueStatement, UA_NS2ID_VISIBILITYENUM);
