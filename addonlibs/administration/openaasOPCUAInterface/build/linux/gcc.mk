...
ADD_LIBS_SWITCHES = ksbase$(_DLL) opcua$(_DLL) ksapi$(_DLL) identification$(_DLL) propertyValueStatement$(_DLL) lifeCycleEntry$(_DLL) MessageSys$(_DLL) openaas$(_DLL) fb$(_DLL)
...
templates: 
	...
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(KSBASE_MODEL_DIR) -I $(OPCUA_MODEL_DIR) -I $(KSAPI_MODEL_DIR) -I $(IDENTIFICATION_MODEL_DIR) -I $(PROPERTYVALUESTATEMENT_MODEL_DIR) -I $(LIFECYCLEENTRY_MODEL_DIR) -I $(MESSAGESYS_MODEL_DIR) -I $(OPENAAS_MODEL_DIR) -I $(FB_MODEL_DIR) -f $(MODEL_DIR)$(LIBRARY).ovm -l $(LIBRARY)
...
$(LIBRARY).c $(LIBRARY).h: $(wildcard $(MODEL_DIR)$(LIBRARY).ov?) Makefile
	sed -i -e 's///' $(MODEL_DIR)$(LIBRARY).ovm
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(KSBASE_MODEL_DIR) -I $(OPCUA_MODEL_DIR) -I $(KSAPI_MODEL_DIR) -I $(IDENTIFICATION_MODEL_DIR) -I $(PROPERTYVALUESTATEMENT_MODEL_DIR) -I $(LIFECYCLEENTRY_MODEL_DIR) -I $(MESSAGESYS_MODEL_DIR) -I $(OPENAAS_MODEL_DIR) -I $(FB_MODEL_DIR) -I $(MODEL_DIR) -f $(MODEL_DIR)$(LIBRARY).ovm -l $(notdir $(basename $<))

%.c %.h: %.ovm Makefile
	sed -i -e 's///' $<
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(KSBASE_MODEL_DIR) -I $(OPCUA_MODEL_DIR) -I $(KSAPI_MODEL_DIR) -I $(IDENTIFICATION_MODEL_DIR) -I $(PROPERTYVALUESTATEMENT_MODEL_DIR) -I $(LIFECYCLEENTRY_MODEL_DIR) -I $(MESSAGESYS_MODEL_DIR) -I $(OPENAAS_MODEL_DIR) -I $(FB_MODEL_DIR) -I $(MODEL_DIR) -f $< -l $(notdir $(basename $<))
