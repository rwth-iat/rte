/*
*   $Id: ov_version.h,v 1.7 2000-04-11 13:22:30 dirk Exp $
*
...
*	-----------------------------------------------------
*/
#define OV_VER_CODEGEN					"1.2.0pre1"
#define OV_VER_LIBOV					"1.2.0pre1"
#define OV_VER_DBUTIL 					"1.2.0pre1"
#define OV_VER_LIBOVKS 					"1.2.0pre1"
#define OV_VER_SERVER					"1.2.0pre1"
#define OV_VER_NTSERVICE				"1.2.0pre1"

#define OV_VER_FILEVERSION_CODEGEN		1, 2, 0, 1
#define OV_VER_FILEVERSION_LIBOV		1, 2, 0, 1
#define OV_VER_FILEVERSION_DBUTIL 		1, 2, 0, 1
#define OV_VER_FILEVERSION_LIBOVKS 		1, 2, 0, 1
#define OV_VER_FILEVERSION_SERVER		1, 2, 0, 1
#define OV_VER_FILEVERSION_NTSERVICE	1, 2, 0, 1

#define OV_VER_PRODUCTVERSION_CODEGEN	1, 2, 0, 1
#define OV_VER_PRODUCTVERSION_LIBOV		1, 2, 0, 1
#define OV_VER_PRODUCTVERSION_DBUTIL 	1, 2, 0, 1
#define OV_VER_PRODUCTVERSION_LIBOVKS 	1, 2, 0, 1
#define OV_VER_PRODUCTVERSION_SERVER	1, 2, 0, 1
#define OV_VER_PRODUCTVERSION_NTSERVICE	1, 2, 0, 1
