...
set fbdfiles {"templates/StaticDisplayComponent.fbd" "templates/Sheet_EngineeringFB.fbd" "templates/Templates_Engineering.fbd" "templates/Templates_ProcessControl.fbd"}

set targetfolder "$::env(ACPLT_HOME)/templates"
