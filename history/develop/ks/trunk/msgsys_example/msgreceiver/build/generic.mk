...
ifeq ($(COMPILER), MSVC)
DEFINES    = /DOV_SYSTEM_$(SYSTEM)=1 /DPLT_SYSTEM_$(SYSTEM)=1 /Dov_library_open_msgreceiver=ov_library_open_msgreceiver_old /DLOG_OV=1 /DENABLE_PEERGUI=1
else
DEFINES    = -DOV_SYSTEM_$(SYSTEM)=1 -DPLT_SYSTEM_$(SYSTEM)=1 -Dov_library_open_msgreceiver=ov_library_open_msgreceiver_old -DLOG_OV_INFO=1 -DLOG_OV_WARNING=1 -DLOG_OV_ERROR=1 -DLOG_OV_DEBUG=1 -DENABLE_PEERGUI=1
# DEFINES    = -DOV_SYSTEM_$(SYSTEM)=1 -DPLT_SYSTEM_$(SYSTEM)=1 -Dov_library_open_msgreceiver=ov_library_open_msgreceiver_old -DLOG_OV_INFO=1
