...
OV_DLLFNCEXPORT OV_TIME* ksapi_getStringVec_varTimeStamp_get(
    OV_INSTPTR_ksapi_getStringVec          pobj
) {
    return &pobj->v_varTimeStamp;
}

OV_DLLFNCEXPORT OV_RESULT ksapi_getStringVec_varTimeStamp_set(
    OV_INSTPTR_ksapi_getStringVec          pobj,
    const OV_TIME*  value
) {
...
OV_DLLFNCEXPORT OV_UINT ksapi_getStringVec_varQState_get(
    OV_INSTPTR_ksapi_getStringVec          pobj
) {
    return pobj->v_varQState;
}

OV_DLLFNCEXPORT OV_RESULT ksapi_getStringVec_varQState_set(
    OV_INSTPTR_ksapi_getStringVec          pobj,
    const OV_UINT  value
) {
...
OV_DLLFNCEXPORT void ksapi_getStringVec_returnMethodxdr(
	...
	//Analyse xdr
	if((analysegetvecreply(OV_VT_STRING_VEC, xdr, xdrlength, (void**) &result, &len_res,
