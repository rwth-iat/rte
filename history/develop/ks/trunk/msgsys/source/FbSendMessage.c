...
OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_constructor(
	OV_INSTPTR_ov_object 	pobj
) {
    /*
    *   local variables
    */
	OV_INSTPTR_msgsys_FbSendMessage this = Ov_StaticPtrCast(msgsys_FbSendMessage, pobj);
...
OV_DLLFNCEXPORT void msgsys_FbSendMessage_typemethod(
    ...
    *   local variables
    */
	OV_INSTPTR_msgsys_FbSendMessage this = Ov_StaticPtrCast(msgsys_FbSendMessage, pfb);
	...
	while(child) {
	  if(Ov_CanCastTo(msgsys_Message, child)){ //if this is a message and not the sendinginstance
		msg = Ov_StaticPtrCast(msgsys_Message, child);
		...
		if (msg->v_msgStatus == MSGNEW) { // take one
			...
			if(msgsys &&
				...
				msgsys_MsgComponent_retrieveMessage_set(msgsys, msg->v_sendString);
				Ov_DeleteObject(msg);
				return;
			}
 ...
 */
OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_doSend_set(
    OV_INSTPTR_msgsys_FbSendMessage          pobj,
    const OV_BOOL  value
) {
	OV_RESULT result = 0;
	...
	//create Mesage obj
	msgsys_CreateAnonymousMessage(msgsys_Message, message, pobj, "Message",&result);
	if(! result) {
	...
	msgsys_Message_senderService_set(message, canonicalServicePath);
    ov_string_setvalue(&canonicalServicePath, NULL);
    ov_memstack_unlock();

	msgsys_Message_receiverAddress_set(message, msgsys_FbSendMessage_HOST_get(pobj));
	msgsys_Message_receiverName_set(message, msgsys_FbSendMessage_SERVER_get(pobj));
	msgsys_Message_receiverService_set(message, msgsys_FbSendMessage_PATH_get(pobj));
	msgsys_Message_msgType_set(message, msgsys_FbSendMessage_TYPE_get(pobj));
	msgsys_Message_msgBody_set(message, msgsys_FbSendMessage_CONTENT_get(pobj));
	pobj->v_ID = pobj->v_ID + 1; //increase ID for this message
	msgsys_Message_msgID_set(message, msgsys_FbSendMessage_ID_get(pobj));

	//set L* variables
	pobj->v_LHOST   = msgsys_FbSendMessage_HOST_get(pobj);
	pobj->v_LSERVER = msgsys_FbSendMessage_SERVER_get(pobj);
	pobj->v_LPATH   = msgsys_FbSendMessage_PATH_get(pobj);
	pobj->v_LTYPE   = msgsys_FbSendMessage_TYPE_get(pobj);
	pobj->v_LCONTENT = msgsys_FbSendMessage_CONTENT_get(pobj);
...
OV_DLLFNCEXPORT OV_BOOL msgsys_FbSendMessage_doSend_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_doSend;
}

OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_SERVER_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_SERVER;
}

OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_SERVER_set(
    OV_INSTPTR_msgsys_FbSendMessage          pobj,
...
OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_HOST_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_HOST;
}

OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_HOST_set(
    OV_INSTPTR_msgsys_FbSendMessage          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_PATH_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_PATH;
}

OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_PATH_set(
    OV_INSTPTR_msgsys_FbSendMessage          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_INT msgsys_FbSendMessage_TYPE_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_TYPE;
}

OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_TYPE_set(
    OV_INSTPTR_msgsys_FbSendMessage          pobj,
    const OV_INT  value
) {
    pobj->v_TYPE = value;
...
OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_CONTENT_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_CONTENT;
}

OV_DLLFNCEXPORT OV_RESULT msgsys_FbSendMessage_CONTENT_set(
    OV_INSTPTR_msgsys_FbSendMessage          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_LSERVER_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_LSERVER;
}

OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_LHOST_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_HOST;
}

OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_LPATH_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_LPATH;
}

OV_DLLFNCEXPORT OV_INT msgsys_FbSendMessage_LTYPE_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_LTYPE;
}

OV_DLLFNCEXPORT OV_STRING msgsys_FbSendMessage_LCONTENT_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_LCONTENT;
}

OV_DLLFNCEXPORT OV_TIME* msgsys_FbSendMessage_LTIM_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return &pobj->v_LTIM;
}

OV_DLLFNCEXPORT OV_INT msgsys_FbSendMessage_ID_get(
    OV_INSTPTR_msgsys_FbSendMessage          pobj
) {
    return pobj->v_ID;
}
