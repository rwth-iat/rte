...
ADD_LIBS = $(USER_DIR)fc/build/nt/fc$(_LIB)
...
.ovm$(_C):
	$(OV_CODEGEN_EXE) -I $(BASE_MODEL_DIR) -I $(fc_MODEL_DIR) -f $(subst /,\\, $<) -l $(notdir $(basename $<))
...
fc.h : $(FC_MODEL_DIR)fc.ovm
	$(OV_CODEGEN_EXE) -f $< -I $(BASE_MODEL_DIR) -I $(FC_MODEL_DIR)

sfc.h : $(MODEL_DIR)sfc.ovm
	$(OV_CODEGEN_EXE) -f $< -I $(BASE_MODEL_DIR) -I $(FC_MODEL_DIR)
